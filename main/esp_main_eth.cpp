...
#include "pd_mdns.h"      // shared pd_mdns_start() (#154)
...
extern "C" void app_main(void)
{
    ...
    // Without this the hostname wouldn't resolve until SipServer constructs (after
    // the gate), making "ssh owner@drawbridge.local" fail on a fresh box. After
    // IP-up is the earliest safe point (mDNS needs the netif attached).
